...
- (void)animateTableView:(UITableView *)tableView show:(BOOL)show complete:(void(^)())complete {
    if (show) {
        ...
        CGFloat tableViewHeight = [self.dataSource menu:self
         numberOfRowsInColumn:self.currentSelectedMenudIndex]* tableView.rowHeight;
        //CGFloat tableViewHeight = ([tableView numberOfRowsInSection:0] > 8) ? (8 * tableView.rowHeight) : ([tableView numberOfRowsInSection:0] * tableView.rowHeight);
